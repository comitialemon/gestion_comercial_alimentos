...
--
-- Dumping data for table `impuestos_ventas_liquidacion_concepto`
--

LOCK TABLES `impuestos_ventas_liquidacion_concepto` WRITE;
/*!40000 ALTER TABLE `impuestos_ventas_liquidacion_concepto` DISABLE KEYS */;
INSERT INTO `impuestos_ventas_liquidacion_concepto` VALUES (10,'Efectivo',2470,5,1),(22,'aksaljdalk',2475,5,1),(23,'asdasd',2470,5,1);
/*!40000 ALTER TABLE `impuestos_ventas_liquidacion_concepto` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-21 17:46:37
