...
class ArqueoCajaChicaCIController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return Inertia::render('Gestion/Reportes/ControlInterno/ArqueoCajaChicaCI', [
    ...
    public function generarPdf(Request $request)
    {
        ...
        if (!$idCuentaCajaChica) {
            throw new \Exception('No se encontró la cuenta de Caja Chica en los parámetros');
        }
        ...
        // SALIDA DEL PDF
        // =============================================
        $nombreArchivo = 'ArqueoCajaChica_Operador_' . $nombreOperador . '_' . $fechaCabecera . '.pdf';
