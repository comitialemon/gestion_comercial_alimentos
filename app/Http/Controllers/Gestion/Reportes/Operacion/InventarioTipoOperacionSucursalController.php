...
class InventarioTipoOperacionSucursalController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // 🔥 Sucursal actual para preseleccionar
        $sucursalActual = session('cliente_sucursal_id');
        
        return Inertia::render('Gestion/Reportes/Operacion/InventarioTipoOperacionSucursal', [
    ...
    /**
     * Exporta el reporte a Excel (CON selector de sucursal)
     */
    public function exportar(Request $request)
    {
        ...
        // SALIDA DEL ARCHIVO
        // =============================================
        $nombreArchivo = 'Inventario_TipoOperacion_' . $sucursalId . '_' . date('Ymd') . '.xls';
