...
class AnularFacturaController extends Controller
{
    ...
    {
        Log::info('=== INICIO ANULAR FACTURA ===');
        ...
        try {
            ...
            // 🔥 2. OBTENER MOVIMIENTOS DE INVENTARIO USANDO EL ID OBTENIDO
            ...
            if ($movimientos->isEmpty()) {
                ...
                // Puedes continuar o lanzar un error
            }
            ...
            Log::info('✅ ANULACIÓN COMPLETA: ' . $movimientosCreados . ' movimientos creados');
