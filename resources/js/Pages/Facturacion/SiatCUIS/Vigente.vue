...
<template>
  <div class="max-w-7xl mx-auto p-4 sm:p-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <!-- Configuración -->
      <div class="bg-gradient-to-br from-secondary-50 to-white rounded-xl border border-secondary-200 p-4 shadow-sm">
        <div class="flex items-center gap-3">
          ...
          <div>
            <div class="text-xs font-medium text-secondary-600 uppercase tracking-wider">Configuración</div>
