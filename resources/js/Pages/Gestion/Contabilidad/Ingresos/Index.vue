                    ...
                    <div v-for="ingreso in ingresos.data" :key="ingreso.IdIngreso" class="bg-white rounded-lg shadow-sm p-3">
                        ...
                        <div class="flex justify-between items-start border-b pb-2 mb-2">
                            ...
                            <div class="flex gap-2">
                                <Link v-if="ingreso.ActivoInactivo === 0" :href="`/gestion/ingresos/${ingreso.IdIngreso}/edit`" class="text-guindo-600" title="Editar">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="ingreso in ingresos.data" :key="ingreso.IdIngreso" class="hover:bg-gray-50">
                                    ...
                                    <td class="px-3 py-2 text-right space-x-1 whitespace-nowrap">
                                        <Link v-if="ingreso.ActivoInactivo === 0" :href="`/gestion/ingresos/${ingreso.IdIngreso}/edit`" class="text-guindo-600 hover:text-guindo-800 text-xs inline-block" title="Editar">
                                            <i class="fas fa-edit text-xs"></i>
                                        </Link>
