...
import ModalShowAjuste from './components/ModalShowAjuste.vue'
...
const ajusteSeleccionadoId = ref(null)

const verDetalle = (ajusteId) => {
    ajusteSeleccionadoId.value = ajusteId
...
// ✅ Usar fecha_mostrar del controller
...
<template>
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 pb-20">
        <div class="py-3 px-3 sm:py-4 sm:px-5 lg:px-6">
            <div class="max-w-full lg:max-w-7xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-sm p-3 mb-4">
                    <div class="flex flex-wrap items-center gap-3">
                        <div class="flex items-center gap-2">
                            ...
                            <select v-model="estadoFiltro" class="border border-gray-300 rounded-lg px-2 py-1 text-xs w-36 sm:w-40 focus:ring-1 focus:ring-primary-500 focus:border-primary-500 outline-none">
                ...
                <div v-if="isMobile" class="space-y-3">
                    <div v-for="ajuste in ajustes.data" :key="ajuste.IdAjustesPrincipal" class="bg-white rounded-xl shadow-sm p-3 border border-gray-100">
                        <div class="flex justify-between items-start border-b pb-2 mb-2">
                            ...
                            <div class="flex gap-2">
                                <button @click="verDetalle(ajuste.IdAjustesPrincipal)" class="text-primary-600 hover:text-primary-800" title="Ver">
                    ...
                    <div v-if="ajustes.data?.length === 0" class="bg-white rounded-xl shadow-sm p-8 text-center">
                    ...
                    <!-- Paginación móvil -->
                    <div v-if="ajustes.links && ajustes.links.length > 1" class="bg-white rounded-xl shadow-sm p-2">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-primary-50">
                                <tr>
                                    <th class="px-3 py-2 text-left text-[10px] font-medium text-primary-700 uppercase">N° Ajuste</th>
                                    <th class="px-3 py-2 text-left text-[10px] font-medium text-primary-700 uppercase">Fecha</th>
                                    <th class="px-3 py-2 text-left text-[10px] font-medium text-primary-700 uppercase">Concepto</th>
                                    <th class="px-3 py-2 text-left text-[10px] font-medium text-primary-700 uppercase">Tipo</th>
                                    <th class="px-3 py-2 text-left text-[10px] font-medium text-primary-700 uppercase">Almacén</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="ajuste in ajustes.data" :key="ajuste.IdAjustesPrincipal" class="hover:bg-gray-50 transition">
        ...
        <ModalShowAjuste
            ...
            :ajuste-id="ajusteSeleccionadoId"
