            ...
            <div class="max-w-full mx-auto">
                ...
                <div class="flex items-center gap-3 mb-5">
                    <div class="w-10 h-10 bg-guindo-100 rounded-xl flex items-center justify-center">
                        <i class="fas fa-chart-line text-guindo-600 text-lg"></i>
                    </div>
                    <div>
                        ...
                        <div class="sucursal-selector relative">
                            ...
                            <div class="relative">
                                <input 
                                    ...
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm lg:text-[15px] focus:ring-guindo-500 focus:border-guindo-500 pr-8"
                                    autocomplete="off"
                                />
                                <button 
                                    v-if="sucursalId"
                            ...
                            <div v-if="mostrarListaSucursales && sucursalesFiltradas.length > 0" 
                                ...
                                <div 
                                    ...
                                    class="px-3 py-2.5 hover:bg-guindo-50 cursor-pointer transition-colors border-b border-gray-100 last:border-b-0"
