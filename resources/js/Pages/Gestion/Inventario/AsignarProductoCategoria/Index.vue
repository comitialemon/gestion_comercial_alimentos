            ...
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-6">
                    <div class="inline-flex items-center justify-center w-14 h-14 bg-emerald-100 rounded-2xl mb-3">
                        <i class="fas fa-link text-xl text-emerald-600"></i>
                    </div>
                    <h1 class="text-xl font-bold text-gray-900">Asignar Productos a Categorías</h1>
                    <p class="text-xs text-gray-500">Selecciona una categoría y elige qué productos mostrarán en el menú táctil</p>
                </div>

                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div class="bg-white rounded-xl shadow-sm p-4">
                        <h2 class="font-semibold text-gray-800 mb-3 flex items-center gap-2">
                            <i class="fas fa-tree text-emerald-600"></i> Categorías
                        </h2>
                        ...
                        <div class="space-y-1 max-h-96 overflow-y-auto">
                            <button
                                ...
                                :class="{
                                    'bg-emerald-50 text-emerald-700 border-l-4 border-emerald-500': categoriaSeleccionada === cat.id,
                    ...
                    <div class="lg:col-span-2 bg-white rounded-xl shadow-sm p-4">
                        <div v-if="categoriaSeleccionada">
                            ...
                            <div class="flex justify-between items-center mb-3">
                                <button @click="seleccionarTodos" class="text-xs text-emerald-600 hover:text-emerald-700">
                            ...
                            <div class="max-h-96 overflow-y-auto">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                    <div v-for="producto in productosFiltrados" :key="producto.id"
                                        ...
                                        :class="{
                                            'border-emerald-400 bg-emerald-50': estaSeleccionado(producto.id),
                                        ...
                                        <div class="w-5 h-5 rounded border flex items-center justify-center"
                                            :class="estaSeleccionado(producto.id) ? 'bg-emerald-500 border-emerald-500' : 'border-gray-300 bg-white'">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="text-xs text-emerald-600 font-semibold">{{ Number(producto.PrecioVenta).toFixed(2) }} Bs</div>
                                        </div>
                            ...
                            <div class="mt-4 pt-3 border-t flex justify-end">
                                <button @click="guardarAsignaciones" :disabled="guardando"
                                    class="px-5 py-2 bg-emerald-600 text-white rounded-lg text-sm font-medium hover:bg-emerald-700 disabled:opacity-50 flex items-center gap-2">
