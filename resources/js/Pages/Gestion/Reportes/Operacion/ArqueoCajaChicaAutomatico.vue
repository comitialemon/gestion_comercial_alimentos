...
const generarReporte = () => {
    ...
    // ✅ URL CORRECTA - Dentro de operacion/reportes
    window.open(`/operacion/reportes/arqueo-caja-chica-automatico/pdf?fecha_id=${fechaId.value}`, '_blank')    
    setTimeout(() => {
        loading.value = false
    }, 1000)
}
            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-sm p-4 sm:p-5 mb-4 sm:mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-lg sm:text-xl font-bold text-gray-800">Arqueo de Caja Chica Bolivianos</h1>
                ...
                <div class="mt-4 p-3 rounded-lg text-xs"
                    ...
                    <strong>Información:</strong> Este reporte genera automáticamente el arqueo de Caja Chica en Bolivianos para el operador y sucursal con los que inició sesión. Seleccione la fecha y presione "Generar PDF".
                </div>
            </div>
        </div>
    </div>
