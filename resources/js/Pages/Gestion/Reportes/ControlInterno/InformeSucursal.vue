...
const generarReporte = () => {
    ...
    window.open(`/gestion/reportes/control-interno/informe-sucursal/exportar?IdFecha=${selectedFecha.value}`, '_blank')
        ...
        <div class="py-6 px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-6">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Seleccione la fecha para generar el reporte</p>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400 mt-1">
                                Seleccione la fecha del movimiento a analizar
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t flex justify-end gap-3">
                        ...
                        <button 
                            ...
                            :disabled="!selectedFecha || loading"
                ...
                <div class="mt-4 text-center text-[10px] text-gray-400">
                    ...
                    El reporte se generará en formato Excel con el análisis completo del movimiento diario.
                </div>
            </div>
        </div>
    </div>
