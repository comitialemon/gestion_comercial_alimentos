...
const generarReporte = () => {
    ...
    window.open(`/gestion/reportes/control-interno/arqueo-caja-bolivianos/pdf?sucursal_id=${sucursalId.value}&fecha_id=${fechaId.value}`, '_blank')
            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-sm p-4 sm:p-6">
                    <div class="space-y-4">
                        ...
                        <!-- Selector de Fecha con autocompletado -->
                        ...
                        <div class="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t mt-4">
                            ...
                            <button 
                                ...
                                :disabled="loading || !sucursalId || !fechaId"
                ...
                <div class="mt-4 p-3 rounded-lg text-xs"
                    ...
                    <strong>Información:</strong> El reporte muestra el arqueo de caja en Bolivianos, incluyendo saldo anterior, ingresos, egresos y saldo actual.
                </div>
            </div>
        </div>
    </div>
