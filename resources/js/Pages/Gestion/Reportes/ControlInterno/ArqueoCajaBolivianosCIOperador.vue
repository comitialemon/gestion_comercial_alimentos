...
const cargarOperadoresPorSucursal = async (sucursalIdParam) => {
    ...
    try {
        const response = await fetch(`/gestion/reportes/control-interno/arqueo-caja-bolivianos-ci-operador/operadores?sucursal_id=${sucursalIdParam}`)
...
const generarReporte = () => {
    ...
    window.open(`/gestion/reportes/control-interno/arqueo-caja-bolivianos-ci-operador/pdf?sucursal_id=${sucursalId.value}&operador_id=${operadorId.value}&fecha_id=${fechaId.value}`, '_blank')
            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-sm p-4 sm:p-5 mb-4 sm:mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-lg sm:text-xl font-bold text-gray-800">Arqueo de Caja Bolivianos por Operador</h1>
                ...
                <div class="mt-4 p-3 rounded-lg text-xs"
                    ...
                    <i class="fas fa-info-circle mr-1"></i>
                    <strong>Información:</strong> El reporte muestra el arqueo de caja en Bolivianos filtrado por operador, incluyendo saldo anterior, ingresos, egresos y saldo actual.
                </div>
            </div>
        </div>
    </div>
