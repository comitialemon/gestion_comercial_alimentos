...
const obtenerNombreVendedor = (detalle) => {
    if (detalle.nombre_vendedor) return detalle.nombre_vendedor
    if (detalle.IdOperadorIngresa === undefined) return '-'
    return `ID: ${detalle.IdOperadorIngresa}`
}
</script>
            ...
            <div class="relative z-10 flex items-center justify-center min-h-screen p-2 sm:p-4">
                <div class="relative bg-white rounded-xl shadow-xl w-full max-w-7xl mx-auto transform transition-all duration-300">
                    ...
                    <div class="p-2 sm:p-4 max-h-[calc(100vh-10rem)] overflow-y-auto">
                            ...
                            <table class="min-w-full divide-y divide-gray-200 text-xs sm:text-sm">
                                <thead class="bg-gray-50 sticky top-0">
                                    <tr>
                                        ...
                                        <th class="px-2 sm:px-3 py-2 text-left font-medium text-gray-500 uppercase">Vendedor</th>
                                        <th class="px-2 sm:px-3 py-2 text-left font-medium text-gray-500 uppercase">Producto</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-100">
                                    <tr v-for="detalle in detalles" :key="detalle.NumeroFactura" class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-2 sm:px-3 py-2 text-gray-600 whitespace-nowrap">{{ obtenerNombreVendedor(detalle) }}</td>
                                ...
                                <tfoot class="bg-gray-50 sticky bottom-0">
                                    <tr class="border-t border-gray-200">
                                        <td colspan="4" class="px-2 sm:px-3 py-2 text-sm font-bold text-gray-800">TOTAL ACUMULADO</td>
                        ...
                        <!-- 🔥 TARJETAS MOBILE - SIEMPRE ABIERTAS -->
                            ...
                            <div v-for="detalle in detalles" :key="detalle.NumeroFactura" class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                                ...
                                <div class="p-3 space-y-2">
                                    <div>
                                        ...
                                        <p class="text-sm font-medium text-gray-800">{{ obtenerNombreVendedor(detalle) }}</p>
                                    </div>
                                    ...
                                    <div v-if="detalle.ProductoInventario" class="pt-1">
                                        <p class="text-[10px] text-gray-500">Producto Inventario</p>
                                        <p class="text-xs text-gray-600 break-words">{{ detalle.ProductoInventario }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
