      ...
      <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-8">
          <div class="inline-flex items-center justify-center w-16 h-16 bg-emerald-100 rounded-2xl mb-4">
            <i class="fas fa-hand-peace text-2xl text-emerald-600"></i>
          </div>
          <h1 class="text-2xl font-bold text-gray-900">Venta Táctil</h1>
          <p class="mt-2 text-sm text-gray-500">
            Selecciona el lugar de venta y el comisionista para comenzar
          </p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div class="px-6 py-4 bg-gray-50 border-t border-gray-100">
            ...
            >
              ...
              {{ loading ? 'Iniciando...' : 'Iniciar Venta Táctil' }}
            </button>
          </div>
        </div>

        <!-- Enlace a venta normal (opcional) -->
        <div class="mt-4 text-center">
          <router-link :to="{ name: 'ventas.crear' }" class="text-sm text-gray-400 hover:text-gray-600">
